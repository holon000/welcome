		...
		base.launch = function(){
			...
			if (base.options.slideshow && base.options.slides.length > 1){
	    		...
	    		if (base.options.autoplay && base.options.slides.length > 1){
					...
					vars.slideshow_interval = setInterval(base.nextSlide, setIntr+2000);				
				}else{
		...
		base.playToggle = function(){
			...
			if (vars.is_paused){
				...
				if(!$.supersized.vars.firstLoad){
					...
					vars.slideshow_interval = setInterval(base.nextSlide, base.options.slides[vars.current_slide].slide_interval+2000);
				}else{
