$(function() {
	...
	JQTWEET = {
	    ...
	    user: 'ethereumproject', //username
	    numTweets: 5, //number of tweets
	    appendTo: '#jstwitter',
	    useGridalicious: true,
	    template: '<div class="slide"><span class="holder"><span class="tweet-wrapper"><h5 class="text">{TEXT}</h5>\
	               <h6><span class="time"><a href="{URL}" target="_blank">{AGO}</a></span>\
	               by <span class="user">{USER}</span></span></h6></span></div>',
